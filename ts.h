...
/* ======= Definicion de los tipos de pasajes de los parametro =======*/

#define PASVALOR      'V'  // identificador de pasaje por valor
#define PASREFERENCIA 'R'  // identificador de pasaje por referencia
